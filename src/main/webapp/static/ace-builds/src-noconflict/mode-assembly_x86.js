ace.define('ace/mode/assembly_x86_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const AssemblyX86HighlightRules = function () {
    this.$rules = {
      start:
       [{
...
ace.define('ace/mode/assembly_x86', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const AssemblyX86HighlightRules = require('./assembly_x86_highlight_rules').AssemblyX86HighlightRules;
...
(function () {
  ace.require(['ace/mode/assembly_x86'], (m) => {
