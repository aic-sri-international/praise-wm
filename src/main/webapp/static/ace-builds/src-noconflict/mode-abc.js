ace.define('ace/mode/abc_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const ABCHighlightRules = function () {
    this.$rules = {
      start: [
        {
...
ace.define('ace/mode/abc', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ABCHighlightRules = require('./abc_highlight_rules').ABCHighlightRules;
