ace.define('ace/mode/applescript_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const AppleScriptHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/applescript', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const AppleScriptHighlightRules = require('./applescript_highlight_rules').AppleScriptHighlightRules;
...
(function () {
  ace.require(['ace/mode/applescript'], (m) => {
