ace.define('ace/mode/diff_highlight_rules', [], (require, exports, module) => {
...
ace.define('ace/mode/folding/diff', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
...
ace.define('ace/mode/diff', [], (require, exports, module) => {
  const oop = require('../lib/oop');
