ace.define('ace/mode/haskell_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const HaskellHighlightRules = function () {
    this.$rules = {
      start:
       [{
         token:
...
ace.define('ace/mode/haskell', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const HaskellHighlightRules = require('./haskell_highlight_rules').HaskellHighlightRules;
...
(function () {
  ace.require(['ace/mode/haskell'], (m) => {
