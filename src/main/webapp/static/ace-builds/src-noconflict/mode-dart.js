...
ace.define('ace/mode/c_cpp_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
...
ace.define('ace/mode/c_cpp', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const c_cppHighlightRules = require('./c_cpp_highlight_rules').c_cppHighlightRules;
...
ace.define('ace/mode/dart_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const DocCommentHighlightRules = require('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const DartHighlightRules = function () {
    const constantLanguage = 'true|false|null';
    const variableLanguage = 'this|super';
    const keywordControl = 'try|catch|finally|throw|rethrow|assert|break|case|continue|default|do|else|for|if|in|return|switch|while|new|deferred|async|await';
    const keywordDeclaration = 'abstract|class|extends|external|factory|implements|get|native|operator|set|typedef|with|enum';
    const storageModifier = 'static|final|const';
    const storageType = 'void|bool|num|int|double|dynamic|var|String';
...
ace.define('ace/mode/dart', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const CMode = require('./c_cpp').Mode;
  const DartHighlightRules = require('./dart_highlight_rules').DartHighlightRules;
  const CStyleFoldMode = require('./folding/cstyle').FoldMode;
