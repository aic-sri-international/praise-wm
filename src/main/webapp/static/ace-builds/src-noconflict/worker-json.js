...
ace.define('ace/mode/json/json_parse', [], (require, exports, module) => {
...
ace.define('ace/mode/json_worker', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const Mirror = require('../worker/mirror').Mirror;
  const parse = require('./json/json_parse');
  ...
  (function () {
    this.onUpdate = function () {
      ...
      try {
        ...
        const pos = this.doc.indexToPosition(e.at - 1);
        errors.push({
          row: pos.row,
          column: pos.column,
          text: e.message,
