...
ace.define('ace/mode/curly_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlHighlightRules = require('./html_highlight_rules').HtmlHighlightRules;


  const CurlyHighlightRules = function () {
...
ace.define('ace/mode/curly', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlMode = require('./html').Mode;
  const MatchingBraceOutdent = require('./matching_brace_outdent').MatchingBraceOutdent;
  const HtmlFoldMode = require('./folding/html').FoldMode;
  const CurlyHighlightRules = require('./curly_highlight_rules').CurlyHighlightRules;
