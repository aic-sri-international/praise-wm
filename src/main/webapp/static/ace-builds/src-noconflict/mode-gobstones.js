...
ace.define('ace/mode/gobstones_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const DocCommentHighlightRules = require('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const GobstonesHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/gobstones', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const JavaScriptMode = require('./javascript').Mode;
  const GobstonesHighlightRules = require('./gobstones_highlight_rules').GobstonesHighlightRules;
...
(function () {
  ace.require(['ace/mode/gobstones'], (m) => {
