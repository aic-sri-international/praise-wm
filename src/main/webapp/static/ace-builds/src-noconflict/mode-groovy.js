...
ace.define('ace/mode/groovy_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const DocCommentHighlightRules = require('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const GroovyHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/groovy', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const JavaScriptMode = require('./javascript').Mode;
  const GroovyHighlightRules = require('./groovy_highlight_rules').GroovyHighlightRules;
