...
ace.define('ace/mode/glsl_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const c_cppHighlightRules = require('./c_cpp_highlight_rules').c_cppHighlightRules;

  const glslHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/glsl', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const CMode = require('./c_cpp').Mode;
  const glslHighlightRules = require('./glsl_highlight_rules').glslHighlightRules;
  const MatchingBraceOutdent = require('./matching_brace_outdent').MatchingBraceOutdent;
  const Range = require('../range').Range;
  const CstyleBehaviour = require('./behaviour/cstyle').CstyleBehaviour;
  const CStyleFoldMode = require('./folding/cstyle').FoldMode;
