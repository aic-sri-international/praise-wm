...
ace.define('ace/mode/csharp_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
...
ace.define('ace/mode/folding/csharp', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
  const Range = require('../../range').Range;
...
ace.define('ace/mode/csharp', [], (require, exports, module) => {
  const oop = require('../lib/oop');
