...
ace.define('ace/mode/haml_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlHighlightRules = require('./html_highlight_rules').HtmlHighlightRules;
  const RubyExports = require('./ruby_highlight_rules');
  const RubyHighlightRules = RubyExports.RubyHighlightRules;

  const HamlHighlightRules = function () {
...
ace.define('ace/mode/haml', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const HamlHighlightRules = require('./haml_highlight_rules').HamlHighlightRules;
