ace.define('ace/mode/cobol_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const CobolHighlightRules = function () {
    const keywords = 'ACCEPT|MERGE|SUM|ADD||MESSAGE|TABLE|ADVANCING|MODE|TAPE|' +
...
ace.define('ace/mode/cobol', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const CobolHighlightRules = require('./cobol_highlight_rules').CobolHighlightRules;
