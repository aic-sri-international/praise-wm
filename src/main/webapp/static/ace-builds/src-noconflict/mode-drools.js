...
ace.define('ace/mode/java_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
...
ace.define('ace/mode/drools_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;
  const JavaHighlightRules = require('./java_highlight_rules').JavaHighlightRules;
  const DocCommentHighlightRules = require('./doc_comment_highlight_rules').DocCommentHighlightRules;
...
ace.define('ace/mode/folding/drools', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
...
ace.define('ace/mode/drools', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const DroolsHighlightRules = require('./drools_highlight_rules').DroolsHighlightRules;
  const DroolsFoldMode = require('./folding/drools').FoldMode;
