ace.define('ace/mode/bro_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const BroHighlightRules = function () {
    this.$rules = {
      start: [{
...
ace.define('ace/mode/bro', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const BroHighlightRules = require('./bro_highlight_rules').BroHighlightRules;
