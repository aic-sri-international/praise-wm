...
ace.define('ace/autocomplete', [], (require, exports, module) => {
  ...
  (function () {
    ...
    this.blurListener = function (e) {
      ...
      const fromTooltip = e.relatedTarget && this.tooltipNode && this.tooltipNode.contains(e.relatedTarget);
      ...
      loop: for (var i = 0, item; item = items[i]; i++) {
        ...
        if (this.exactMatch) {
          ...
          if ((a = caption.toLowerCase().indexOf(lower)) > -1) {
            for (let k = a; k < a + lower.length; k++) {
              matchMask |= (1 << k);
            }
          } else {
...
ace.define('ace/ext/language_tools', [], (require, exports, module) => {
  const snippetManager = require('../snippets').snippetManager;
