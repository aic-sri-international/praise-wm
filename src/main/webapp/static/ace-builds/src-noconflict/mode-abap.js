ace.define('ace/mode/abap_highlight_rules', [], (require, exports, module) => {
  ...
  const AbapHighlightRules = function () {
    ...
    const compoundKeywords = 'WITH\\W+(?:HEADER\\W+LINE|FRAME|KEY)|NO\\W+STANDARD\\W+PAGE\\W+HEADING|' +
...
ace.define('ace/mode/abap', [], (require, exports, module) => {
  const Rules = require('./abap_highlight_rules').AbapHighlightRules;
