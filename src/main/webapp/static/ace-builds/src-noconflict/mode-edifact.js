...
ace.define('ace/mode/edifact_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const DocCommentHighlightRules = require('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const EdifactHighlightRules = function () {
    var header = (
      'UNH'
    );
    const segment = (
...
ace.define('ace/mode/edifact', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const EdifactHighlightRules = require('./edifact_highlight_rules').EdifactHighlightRules;
