ace.define('ace/mode/haskell_cabal_highlight_rules', [], (require, exports, module) => {
...
ace.define('ace/mode/folding/haskell_cabal', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
...
ace.define('ace/mode/haskell_cabal', [], (require, exports, module) => {
  const oop = require('../lib/oop');
...
(function () {
  ace.require(['ace/mode/haskell_cabal'], (m) => {
