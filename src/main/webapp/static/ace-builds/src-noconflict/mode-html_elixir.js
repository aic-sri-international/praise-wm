...
ace.define('ace/mode/elixir_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const ElixirHighlightRules = function () {
    this.$rules = {
      start:
       [{
         token:
...
ace.define('ace/mode/html_elixir_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlHighlightRules = require('./html_highlight_rules').HtmlHighlightRules;
  const ElixirHighlightRules = require('./elixir_highlight_rules').ElixirHighlightRules;

  const HtmlElixirHighlightRules = function () {
...
ace.define('ace/mode/elixir', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ElixirHighlightRules = require('./elixir_highlight_rules').ElixirHighlightRules;
...
ace.define('ace/mode/html_elixir', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlElixirHighlightRules = require('./html_elixir_highlight_rules').HtmlElixirHighlightRules;
  const HtmlMode = require('./html').Mode;
  const JavaScriptMode = require('./javascript').Mode;
  const CssMode = require('./css').Mode;
  const ElixirMode = require('./elixir').Mode;
...
(function () {
  ace.require(['ace/mode/html_elixir'], (m) => {
