ace.define('ace/mode/sh_highlight_rules', [], (require, exports, module) => {
...
ace.define('ace/mode/sh', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ShHighlightRules = require('./sh_highlight_rules').ShHighlightRules;
  const Range = require('../range').Range;
...
ace.define('ace/mode/dockerfile_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const ShHighlightRules = require('./sh_highlight_rules').ShHighlightRules;
...
ace.define('ace/mode/dockerfile', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const ShMode = require('./sh').Mode;
  const DockerfileHighlightRules = require('./dockerfile_highlight_rules').DockerfileHighlightRules;
  const CStyleFoldMode = require('./folding/cstyle').FoldMode;
...
(function () {
  ace.require(['ace/mode/dockerfile'], (m) => {
