...
ace.define('ace/mode/d_highlight_rules', [], (require, exports, module) => {
  ...
  const DHighlightRules = function () {
    ...
    const identifierRe = '[a-zA-Z_\u00a1-\uffff][a-zA-Z\\d_\u00a1-\uffff]*\\b';
    this.$rules = {
      start: [
        { // -------------------------------------------------------- COMMENTS
          token: 'comment',
        ...
        DocCommentHighlightRules.getStartRule('doc-start'),
        {
          ...
          onMatch(value, currentState, state) {
...
ace.define('ace/mode/d', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const DHighlightRules = require('./d_highlight_rules').DHighlightRules;
