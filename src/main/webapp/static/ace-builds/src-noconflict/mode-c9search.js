ace.define('ace/mode/c9search_highlight_rules', [], (require, exports, module) => {
      ...
      start: [
        {
          ...
          onMatch(val, state, stack) {
            ...
            if (values[3]) {
              if (values[3] == ' ') { tokens[1] = { type: types[1], value: `${values[2]} ` }; } else { tokens.push({ type: types[1], value: values[3] }); }
            }
            const regex = stack[1];
            const str = values[4];
...
ace.define('ace/mode/folding/c9search', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
  const Range = require('../../range').Range;
...
ace.define('ace/mode/c9search', [], (require, exports, module) => {
  const oop = require('../lib/oop');
