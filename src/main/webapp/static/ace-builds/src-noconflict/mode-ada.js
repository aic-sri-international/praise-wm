ace.define('ace/mode/ada_highlight_rules', [], (require, exports, module) => {
...
ace.define('ace/mode/ada', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const AdaHighlightRules = require('./ada_highlight_rules').AdaHighlightRules;
