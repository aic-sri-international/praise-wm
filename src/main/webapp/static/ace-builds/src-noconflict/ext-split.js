ace.define('ace/split', [], (require, exports, module) => {
  ...
  (function () {
    ...
    this.$createEditor = function () {
      ...
      const editor = new Editor(new Renderer(el, this.$theme));
    ...
    this.setSession = function (session, idx) {
      ...
      const isUsed = this.$editors.some(editor => editor.session === session);
...
ace.define('ace/ext/split', [], (require, exports, module) => {
  module.exports = require('../split');
});
(function () {
  ace.require(['ace/ext/split'], (m) => {
