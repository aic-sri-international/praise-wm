...
ace.define('ace/mode/handlebars_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlHighlightRules = require('./html_highlight_rules').HtmlHighlightRules;
  ...
  const HandlebarsHighlightRules = function () {
...
ace.define('ace/mode/behaviour/html', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
  const XmlBehaviour = require('../behaviour/xml').XmlBehaviour;
...
ace.define('ace/mode/handlebars', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlMode = require('./html').Mode;
  const HandlebarsHighlightRules = require('./handlebars_highlight_rules').HandlebarsHighlightRules;
  const HtmlBehaviour = require('./behaviour/html').HtmlBehaviour;
  const HtmlFoldMode = require('./folding/html').FoldMode;
...
(function () {
  ace.require(['ace/mode/handlebars'], (m) => {
