ace.define('ace/mode/hjson_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const HjsonHighlightRules = function () {
    this.$rules = {
      start: [{
        include: '#comments',
      }, {
...
ace.define('ace/mode/hjson', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const HjsonHighlightRules = require('./hjson_highlight_rules').HjsonHighlightRules;
