ace.define('ace/mode/fortran_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const FortranHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/fortran', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const FortranHighlightRules = require('./fortran_highlight_rules').FortranHighlightRules;
...
(function () {
  ace.require(['ace/mode/fortran'], (m) => {
