ace.define('ace/mode/apache_conf_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const ApacheConfHighlightRules = function () {
    this.$rules = {
      start:
       [{
         token:
...
ace.define('ace/mode/apache_conf', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ApacheConfHighlightRules = require('./apache_conf_highlight_rules').ApacheConfHighlightRules;
...
(function () {
  ace.require(['ace/mode/apache_conf'], (m) => {
