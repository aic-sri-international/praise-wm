ace.define('ace/mode/batchfile_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const BatchFileHighlightRules = function () {
    this.$rules = {
      start:
       [{
...
ace.define('ace/mode/batchfile', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const BatchFileHighlightRules = require('./batchfile_highlight_rules').BatchFileHighlightRules;
...
(function () {
  ace.require(['ace/mode/batchfile'], (m) => {
