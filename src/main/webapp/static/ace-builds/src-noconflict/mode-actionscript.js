ace.define('ace/mode/actionscript_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const ActionScriptHighlightRules = function () {
    this.$rules = {
      start:
       [{
...
ace.define('ace/mode/actionscript', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ActionScriptHighlightRules = require('./actionscript_highlight_rules').ActionScriptHighlightRules;
...
(function () {
  ace.require(['ace/mode/actionscript'], (m) => {
