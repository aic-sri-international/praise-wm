...
ace.define('ace/mode/asl_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const DocCommentHighlightRules = require('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const ASLHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/asl', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ASLHighlightRules = require('./asl_highlight_rules').ASLHighlightRules;
