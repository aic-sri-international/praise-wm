ace.define('ace/mode/asciidoc_highlight_rules', [], (require, exports, module) => {
...
ace.define('ace/mode/folding/asciidoc', [], (require, exports, module) => {
  const oop = require('../../lib/oop');
...
ace.define('ace/mode/asciidoc', [], (require, exports, module) => {
  const oop = require('../lib/oop');
...
(function () {
  ace.require(['ace/mode/asciidoc'], (m) => {
