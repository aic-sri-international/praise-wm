ace.define('ace/mode/clojure_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;


  const ClojureHighlightRules = function () {
...
ace.define('ace/mode/matching_parens_outdent', [], (require, exports, module) => {
...
ace.define('ace/mode/clojure', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ClojureHighlightRules = require('./clojure_highlight_rules').ClojureHighlightRules;
...
(function () {
  ace.require(['ace/mode/clojure'], (m) => {
