ace.define('ace/mode/erlang_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const ErlangHighlightRules = function () {
    this.$rules = {
      start:
...
ace.define('ace/mode/erlang', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const ErlangHighlightRules = require('./erlang_highlight_rules').ErlangHighlightRules;
