...
ace.define('ace/mode/ftl_highlight_rules', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const HtmlHighlightRules = require('./html_highlight_rules').HtmlHighlightRules;
  const TextHighlightRules = require('./text_highlight_rules').TextHighlightRules;

  const FtlLangHighlightRules = function () {
  ...
  const FtlHighlightRules = function () {
...
ace.define('ace/mode/ftl', [], (require, exports, module) => {
  const oop = require('../lib/oop');
  const TextMode = require('./text').Mode;
  const FtlHighlightRules = require('./ftl_highlight_rules').FtlHighlightRules;
