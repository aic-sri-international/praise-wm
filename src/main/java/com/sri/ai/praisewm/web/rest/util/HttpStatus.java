...
public final class HttpStatus {
  // The request was successful and there is content in the response body
  // unless the status is sent in response to a HEAD request, in which case, there will not be
  // a message body.
  public static final int OK = 200;
  // Resource was created and the response contains a Location header
  // that the client can use to get the newly created resource.
