...
public class QueryRunner {
  private static final Logger LOG = LoggerFactory.getLogger(QueryRunnerTest.class);
    ...
    public QueryRunner(String model, String query, ProceduralAttachments pa) {
      TemperatureProcedure p = TemperatureProcedure.class.cast(pa.get(ProcedureNames.TEMPERATURE));
      TemperatureProcedurePayload payload = new TemperatureProcedurePayload()
                                                .setDate(Instant.now())
